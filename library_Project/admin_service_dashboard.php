...
td, a{
    color:black;
        ...
        body {
            font-family: 'Roboto';
            /* background-image: url('images/ahad.jpg'); */
...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="container">
        <div class="innerdiv">
            <div class="row"><img class="imglogo" src="images/library-logo.png"/></div>
            ...
            <div><label>Branch:</label><input type="radio" name="branch" value="other"/>Other<input type="radio" name="branch" value="BSIT"/>CSE<div style="margin-left:80px"><input type="radio" name="branch" value="BSCS"/>EEE<input type="radio" name="branch" value="BSSE"/>SE</div>
            </div>   
